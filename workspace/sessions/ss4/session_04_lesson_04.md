...
### Bước 1 — Thiết lập tệp tin `.gitignore`
...
### Bước 2 — Thực hành sửa đổi commit gần nhất (Git Amend)
...
### Bước 3 — Trải nghiệm trạng thái Detached HEAD
...
### Bước 4 — Thực hành Git Reset (--soft và --mixed)
...
### Bước 5 — Thực hành Git Reset --hard (Xóa triệt để)
...
### Bước 6 — Thực hành đảo ngược an toàn với Git Revert
...
### Bước 7 — Thực hành trích xuất chọn lọc với Git Cherry-pick
