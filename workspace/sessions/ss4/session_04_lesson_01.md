...
### Step 2 — Cấu hình thông tin danh tính (Identity Config)
...
### Step 3 — Tạo file mới và kiểm tra trạng thái (Status checking)
...
### Step 4 — Đưa file vào vùng đệm (Staging Area)
...
### Step 5 — Thực hiện Commit lưu snapshot
...
### Step 6 — Sửa đổi file, xem sự khác biệt và lịch sử commit
